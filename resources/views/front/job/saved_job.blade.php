    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-9 col-lg-10 col-md-12">
                <h3 class="searchHeading">Save Jobs</h3>
                <div class="searchBox">
                        ...
                        <div class="job_modal_body_inner">
                            <div class="row ml-0 mr-0">
                                ...
                                <div class="job_modal_body_right">
                                    <div class="btn_group">
                                        <a type="button" href="javascript:void(0)" class="btn submit_proposal" id="saveBtn" onclick="jobApply({{$item->job_id}})">Submit a Proposal</a>
