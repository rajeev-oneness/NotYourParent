                ...
                if(data.error == false) {
                    ...
                    if(data.data.length > 0) {
                        $.each(data.data, function(i, val) {
                            ...
                            courses += '<div class="mentor_course_review_name"><h5>'+val.teacher_detail.name+'</h5><h6>'+val.teacher_detail.short_description+'</h6></div></div><p>'+val.course_desc+'</p><ul><li><a href="#">Consult Now</a></li><li><a href="#">Visit Profile</a></li></ul></div></div></div>';
                        });
